...
public class Player extends Entity {
   ...
   // public Map<String, Integer> pokemonData = new HashMap<>();
    ...
    public void pickUpIItem(int i) {
        if (i != 999) {
            ...
            switch (itemName) {
                ...
                case "Charizard", "Jigglypuff":
                    if (numBalls > 0) {
                        gp.player.playerPokemons.add(gp.item[i]);

                        gp.item[i] = null;
                        numBalls--;
                        gp.ui.showMessage("YOU GOT A POKEMON!!!");
                ...
                case "pikachu" :
                    ...
                    if (gp.player.playerPokemons.size() > 0){
                       // gp.player.playerPokemons.get(0).pHP -= 50;
                       // System.out.println(gp.player.playerPokemons.get(0).pHP);
                        gp.gameState = gp.battleState;
                    }else {
                        gp.ui.showMessage("pls get your first Pokemon before entering battle");
                    }
                    break;
                }
            }
